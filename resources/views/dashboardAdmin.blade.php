					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="{{url('/AdminDashboard/Logout')}}"><i class="lnr lnr-exit"></i> <span>Logout</span></a></li>
							</ul>
						</li>
					</ul>
				</div>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="elements.html" class=""><i class="lnr lnr-smartphone"></i> <span>Item</span></a></li>
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="page-profile.html" class="">Category</a></li>
